/*
  ...
  - You are about to drop the column `descripton` on the `Game` table. All the data in the column will be lost.
...
INSERT INTO "new_Game" ("GenreId", "Priority", "PublisherId", "editor", "id", "releaseDate", "title") SELECT "GenreId", "Priority", "PublisherId", "editor", "id", "releaseDate", "title" FROM "Game";
DROP TABLE "Game";
